...
def initializeParameterFiles():
    ...
    param['windSpeed'] = 2*[10,12,11,15,20] # wind speed of the different layers in [m.s-1]
    ...
    param['diameter'] = 8 # M1 diameter [m]
    param['nSubap'] = 40 # number of actuators on the DM -1 ; number of subaps in the diameter of the pyramid pupil mask
    ...
    param['nSubapDm'] = param['nSubap'] # nAct - 1
